...
def check_updates(version):
    try:
        ...
        if version_update_source != version:
            print(f"\n{RED}[!]{END} Your Current Version Is {version} And The Available Update Version Is {version_update_source}, You Can Type 'whoami' And You Will See Our Github Link So You Can Use It To Install The Latest Version.")
